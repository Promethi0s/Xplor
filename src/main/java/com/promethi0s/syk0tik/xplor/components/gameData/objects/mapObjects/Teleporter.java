...
public class Teleporter extends MapObject implements ActiveTile {
    ...
    public Teleporter(int x, int y) {
        ...
        setBehaviors(new CollisionBehavior(), new PositionStatic(new Coordinates(x, y), Sprite.empty), new UpdateTeleporter(this, new Coordinates(16, 16)), new InventoryNone(), new AttackNone(), new UseNone(), new BuffNone());
