...
public class Teleporter extends MapObject implements ActiveTile {
    ...
    public Teleporter(int x, int y) {
        ...
        setBehaviors(new CollisionBehavior(), new PositionLayer0Static(new Coordinates(x, y), Sprite.empty), new UpdateTeleporter(this, new Coordinates(16, 16)), new CombatNone());
