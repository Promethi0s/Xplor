...
public class Player extends Mob implements Living {
    ...
    public Player(Coordinates spawnPoint) {
        ...
        setBehaviors(new CollisionBehavior(), new PositionLayer1Mobile(this, spawnPoint, 0, 5, Sprite.player), new UpdatePlayer(this), new InventoryStandard(10, 2), new CombatMob(this, 10, 1), new UseNone(), new BuffNone());
